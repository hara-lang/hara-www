...
const required = [
  ...
  "rust/std/substrate.hal",
  "rust/std/substrate/frame.hal",
  "rust/std/substrate/json.hal",
  "rust/std/substrate/core.hal",
  "rust/std/substrate/protocol.hal",
  "rust/std/substrate/pubsub.hal",
  "rust/std/substrate/request.hal",
  "rust/std/substrate/router.hal",
  "rust/std/substrate/space.hal",
  "rust/std/substrate/transport_memory.hal",
  "rust/std/substrate/util.hal",
  "rust/std/substrate/util_handlers.hal",
  "examples/index.json",
